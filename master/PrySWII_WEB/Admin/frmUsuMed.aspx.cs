...
using PrySWII_BE;
using PrySWII_BL;
public partial class Admin_frmUsuMed : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                gvMedicos.DataSource = objEmpleadoBL.ListarUsuarioMedicos();
                gvMedicos.DataBind();
    ...
    void Application_Start()
    {
        ...
        List<UsuMedicoBE> listUsers = new LoginBL().ListarUsuarioMedicos();

        foreach (UsuMedicoBE user in listUsers)
        {
