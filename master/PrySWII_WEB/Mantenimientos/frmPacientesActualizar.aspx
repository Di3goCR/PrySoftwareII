<%@ Page Title="" Language="C#" MasterPageFile="~/SiteAdm.master" AutoEventWireup="true" CodeFile="frmPacientesActualizar.aspx.cs" Inherits="Mantenimientos_frmPacientesActualizar" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
    <table border="2">
            <caption>
                <span style="color: #000099">ACTUALIZAR PACIENTE</span></caption>
         <tr>
                <td class="style1">
                    <span style="color: #3399ff">
                        <asp:Label ID="Label14" runat="server" ForeColor="#0066FF" Text="Codigo:" Width="160px"></asp:Label></span></td>
                <td class="auto-style3">
                    <asp:Label ID="lblCod" runat="server" BorderStyle="Inset" Width="187px"></asp:Label>
                    </td>
                <td></td>
                <td></td>
            </tr>
