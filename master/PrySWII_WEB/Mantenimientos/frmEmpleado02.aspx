<%@ Page Title="" Language="C#" MasterPageFile="~/SiteAdm.master" AutoEventWireup="true" CodeFile="frmEmpleado02.aspx.cs" Inherits="Mantenimientos_frmEmpleado02" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
    <table border="2">
            <caption>
                <span style="color: #000099">NUEVO EMPLEADO</span></caption>
            <tr>
                <td class="style1">
