<%@ Page Title="" Language="C#" MasterPageFile="~/SiteAdm.master" AutoEventWireup="true" CodeFile="frmPacientes.aspx.cs" Inherits="Mantenimientos_frmPacientes" %>
    ...
    <table border="2">
        ...
        <tr>
            <td style="width: 100px">
                <asp:GridView ID="gvPacientes" HorizontalAlign="Left" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="NomPaciente" HeaderText="Nombres" />
                        <asp:BoundField DataField="ApePacPat" HeaderText="Apellidos" />
                        <asp:BoundField HeaderText="Sexo" DataField="Sexo" />
                        <asp:BoundField DataField="NroIdentidad" HeaderText="Documento" />
                        <asp:BoundField DataField="Direccion" HeaderText="Direccion" />
                        <asp:BoundField DataField="IdDistrito" HeaderText="Distrito" />
                        <asp:BoundField DataField="Telefono" HeaderText="Telefono" />
                        <asp:BoundField DataField="Celular" HeaderText="Celular" />
                        <asp:BoundField DataField="Email" HeaderText="Correo" />
                        <asp:BoundField DataField="TipSangrePac" HeaderText="Tipo de Sangre" />
                        <asp:BoundField DataField="TallaPac" HeaderText="Talla" />
                        <asp:BoundField DataField="PesoPac" HeaderText="Peso" />
                    </Columns>
